          ...
          <tbody className="table-group-divider">
            {usersList.map((u, idx) => (
              <tr key={u.id || idx}>
                ...
                <td>{u.username}</td>
                <td>
                  <CButton color="primary" size="sm" onClick={() => handleEdit(u)}>
                    Editar
                  </CButton>{' '}
        ...
        <CModalBody>
          <CForm onSubmit={handleSave}>
            ...
            <CFormInput
              ...
              placeholder="Password (dejar vacío si no cambia)"
            />

            <div className="d-flex justify-content-end">
              <CButton color="secondary" onClick={() => setModalVisible(false)} className="me-2">
                Cancelar
              </CButton>
